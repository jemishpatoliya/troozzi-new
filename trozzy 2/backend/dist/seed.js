...
async function main() {
    ...
    function categorySkuPrefix(category) {
        ...
        if (normalized.includes("foot"))
            return "FOO";
        if (normalized.includes("groc"))
            return "GRO";
        if (normalized.includes("beaut"))
            return "BEA";
    ...
    function stableImagesForCategory(category, seed) {
    ...
    function makeExtraProducts(count, startIndex) {
        const categories = [
            "Fashion",
            "Electronics",
            "Bags",
        ...
        for (let i = 0; i < count; i++) {
            ...
            const colors = category === "Fashion" || category === "Bags" || category === "Footwear"
                ? ["Black", "Blue", "White"]
                : [];
            extra.push({
                slug,
