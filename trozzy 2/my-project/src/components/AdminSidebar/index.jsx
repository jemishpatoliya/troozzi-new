                                ...
                                {item.children ? (
                                    <div>
                                        <button
                                            ...
                                            className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isActive(item.path) || item.children.some(child => isActive(child.path))
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {isReviewsOpen ? <FaChevronDown className="w-4 h-4" /> : <FaChevronRight className="w-4 h-4" />}
                                            </div>
                                        </button>
                                            ...
                                            <ul className="mt-2 ml-4 space-y-1">
                                                {item.children.map((child, childIndex) => (
                                                    <li key={childIndex}>
                                                        <Link
                                                            to={child.path}
                                                            className={`flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${isActive(child.path)
                                                                    ? 'bg-blue-100 text-blue-700'
                                                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                                                }`}
                                                        >
