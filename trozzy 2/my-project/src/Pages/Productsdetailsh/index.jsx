            ...
            <section className='bg-white py-5'>
                ...
                <div className='container flex gap-8 items-center'>
                    <div className='productzoomcontainer w-[40%]'>
                        <ProductZoom product={product} selectedColorVariant={selectedColorVariant} />
                    </div>
                    <ProductDetalisComponent product={product} selectedColorVariant={selectedColorVariant} onColorSelect={setSelectedColorVariant} />
                </div>
